    ...
    <section className="lg:flex justify-between">
      <div className="lg:w-[55%] md:py-14 relative lg:px-10 px-4 py-4">
        <div className="flex justify-end border-blue-900">
          <div className="lg:w-[80%] w-[100%] h-[20em] bg-orange-800 lg:mr-6 mx-2"></div>
          <div className="absolute top-0 left-10 h-[4em] md:h-[7em] w-[4em] md:w-[7em] hidden lg:block bg-stone-600 rounded-md"></div>
          <div className="absolute bottom-0 md:left-28 left-20 h-[4em] md:h-[7em] w-[4em] hidden lg:block md:w-[7em] bg-stone-600 rounded-md"></div>
          <div className="absolute bottom-10 h-[6em] md:h-[10em] w-[6em] md:w-[10em] hidden lg:block bg-stone-600 rounded-md"></div>
          <div className=""></div>
          <div></div>
        </div>
      </div>
