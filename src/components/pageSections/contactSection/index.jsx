    ...
    <section className="lg:flex justify-between">
      <div className="lg:w-[55%] md:py-14 relative lg:px-10 px-4 py-4">
        <div className="flex justify-end border-blue-900">
          <div className="lg:w-[80%] w-[100%] h-[20em] bg-orange-800 lg:mr-6 mx-2 rounded-lg">
            <Image
      ...
      <div className="lg:w-[40%] flex flex-col justify-center px-2 md:px-6 my-10 lg:my-0">
        <form className="w-100 flex flex-col py-10 px-5 shadow-lg">
          <input
            ...
            className="p-3 rounded-md my-3 text-sm border-[1px] border-amber-700 border-opacity-20"
          />
          <textarea
            name="message"
            ...
            onChange={handleInput}
            className="resize-none h-[5em] p-3 rounded-md my-3 text-sm border-[1px] border-amber-700 border-opacity-20"
          />
