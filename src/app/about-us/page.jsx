          ...
          <div className="md:ml-10 px-5">
            <div className="mb-20">
              ...
              <p>
                ...
                adipisci architecto, velit impedit ducimus qui quisquam
                deserunt, cumque ex consequatur, ab inventore et veritatis nisi?
                Doloremque incidunt at quia libero. Dolore illum nisi ullam aut,
                distinctio tenetur praesentium sit totam nesciunt? Dignissimos
                dolores ea exercitationem dolorum doloremque quas aliquid sit
                nulla ad? Dolorum laborum ea pariatur maiores consequatur
                aliquid cum enim explicabo id inventore laudantium, ipsum fugit
                accusamus tenetur ab, consequuntur ad repellendus! Nemo harum
                tempore vero quis nostrum molestias sed id? Iste modi et
                architecto error alias eaque omnis deleniti est optio facere!
              </p>
            </div>
            <div className="my-20">
              ...
              <div className="custom-grid w-full justify-between py-8">
                {services.map((service, index) => (
                  <div
                    key={service.name}
                    className="bg-stone-600 lg:w-[12em] w-full h-[13em] rounded-md mx-8"
                  ></div>
                ))}
              </div>
            </div>
